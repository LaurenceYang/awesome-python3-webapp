...
env.user = 'ubuntu'
# env.sudo_user = 'root'
env.hosts = ['ec2-54-249-65-213.ap-northeast-1.compute.amazonaws.com']
env.key_filename = '~/laurenceyang.pem'
...
_REMOTE_BASE_DIR = '/srv/laurenceyang'
